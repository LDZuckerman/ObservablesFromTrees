...
srun python ObservablesFromTrees/run_sweep.py -f $expfile -d $difffile -gpu 1

####
# sbatch ObservablesFromTrees/run_sweep.sh -f Task_phot/expfile.json -d Task_phot/difffile.json
####